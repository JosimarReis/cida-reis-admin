 ...
 */
class Version20180425011406 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE produto ADD categoria_id INT NOT NULL, CHANGE preco preco NUMERIC(10, 2) NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE produto DROP categoria_id, CHANGE preco preco NUMERIC(2, 0) NOT NULL');
    }
}
