 ...
 */
class Version20180424234312 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE produto ADD categoria_id INT NOT NULL, CHANGE preco preco NUMERIC(10, 2) NOT NULL, CHANGE visivel visivel TINYINT(1) DEFAULT \'true\' NOT NULL');
